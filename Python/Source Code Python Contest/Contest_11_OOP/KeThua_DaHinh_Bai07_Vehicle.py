...
def main() -> None:
    ...
    search_vehicle_manufacturer = input()
    print(f"DANH SACH XE HANG {search_vehicle_manufacturer} :")
    for car in list_cars:
        if car.get_manufacturer() == search_vehicle_manufacturer:
            print(car)

    for motorbike in list_motorbikes:
        if motorbike.get_manufacturer() == search_vehicle_manufacturer:
            print(motorbike)
